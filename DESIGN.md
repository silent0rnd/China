# DESIGN - Горизонт, hero checkpoint

## 1. Visual Theme & Atmosphere

Тёмный логистический коридор для B2B-перевозок из Китая в Россию. Hero строится как холодная графитовая пограничная сцена: крупная спокойная типографика слева, реальный утверждённый визуальный материал справа, точечный красный маршрут как знак движения и контроля.
...
|---|---|---:|---:|---:|---:|
| H1 | Manrope, Arial, sans-serif | clamp(38px, 4.2vw, 76px) | 500 | 1.05 | -0.03em |
| Eyebrow | IBM Plex Mono, Consolas, monospace | 12px | 500 | 1.4 | 0.08em |
| Lead | Manrope, Arial, sans-serif | 20px | 400 | 1.55 | 0 |
| Body | Manrope, Arial, sans-serif | 16px | 400 | 1.6 | 0 |
| Button | Manrope, Arial, sans-serif | 15px | 500 | 1 | 0 |
...
- Сохранять асимметрию hero и читаемую текстовую колонку.
...
Hero: тёмный `#07090B` фон, H1 Manrope 500 с `clamp(38px, 4.2vw, 76px)`, направление текста слева и утверждённая логистическая сцена справа. Основной CTA `#ECEEEF` с тёмным текстом, secondary CTA прозрачный с границей `#3A424A`. Красный `#A92B27` используется только в маршрутной метке и focus.
