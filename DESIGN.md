...
- Галерею реальных грузов собирать в masonry-композицию без наложений, сохраняя вертикальные, квадратные и горизонтальные пропорции кадров.
- Фоновая сцена hero статична, параллакс не используется.
